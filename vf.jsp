                ...
                <div id="header">
                    ...
                    <div id="menu">
                        <ul>
                            ...
                            <li><a href="vf.jsp" class="active">View All Files</a></li>
...
<!--                                <img src="images/contact.png" alt="" title="" style="float: left; padding-right: 10px;" />-->
                                <h4>View All Files</h4>
                                <div class="pad_left">
                                    <%@include file="jdbc.jsp" %>
                                    <center>
                                        <table border="">
                                            <tr><th><font size="4" color="red">CLOUD NAME</font></th><th><font size="4" color="red">FILE NAME</font></th><th><font size="4" color="red">USER NAME</font></th><th><font size="4" color="red">DOWNLOAD</font></th></tr>
                                            <%
...
while(rs.next()) {                             
%>
<tr><td><font size="4" color="blue"><%=rs.getString(7)%></font></td><td><font size="4" color="blue"><%=rs.getString(1)%></font></td><td><font size="4" color="blue"><%=rs.getString(2)%></font></td>
    <td><form action="DownLoad.jsp">
            <td><input type="hidden" value="<%=rs.getString(1)%>" name="fileid" readonly></td>
            <td><input type="hidden" value="<%=rs.getString(2)%>" name="sender" readonly></td>
                            <td><input type="submit" value="DOWNLOAD"></td></form></td>
