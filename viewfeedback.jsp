<%-- 
    ...
    Created on : Aug 31, 2016, 6:51:38 PM
    Author     : shaiksardar
--%>
                ...
                <div id="header">
                    ...
                    <div id="menu">
                        <ul>
                            ...
                            <li><a href="addcloud.jsp">Add Cloud</a></li>
                            <li><a href="cviewuser.jsp">ViewUser</a></li>
                            <li><a href="cviewfiles.jsp">Viewfiles</a></li>
                            <li><a href="viewfeedback.jsp" class="active">Viewfeedback</a></li>
...
<!--                                <img src="images/contact.png" alt="" title="" style="float: left; padding-right: 10px;" />-->
                               ...
                               <center>
                                    <table border="">
                                        <tr><th><font size="4" color="red">NAME</font></th><th><font size="4" color="red">MESSAGE</font></th></tr>
...
while(rs.next()){
%>
<tr><td><font size="4" color="blue"><%=rs.getString(1)%></font></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td><font size="4" color="blue"><%=rs.getString(2)%></font></td></tr>
<%
}
%>
                                    </table>
