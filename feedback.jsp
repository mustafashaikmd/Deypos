<%-- 
    Document   : feedback
    Created on : Aug 31, 2016, 6:20:24 PM
    Author     : shaiksardar
--%>
...
String sql="select * from REGISTER where EMAIL='"+n+"'"; 
Statement s=con.createStatement();
ResultSet rs=s.executeQuery(sql);
if(rs.next())                              
%>
<div id="contact_form">
    <form id="form2" method="post" action="feedbackDB.jsp">
                                            <fieldset>
                                                <label for="con_name">ID:</label><br />
                                                <input id="con_name" type="text" name="id" value="<%=rs.getString(2)%>" alt=""/><br />
                                                <label for="con_mess">Message:</label><br />
                                                <textarea id="con_mess" name="mess" cols="0" rows="0"></textarea><br />
