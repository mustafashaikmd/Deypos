<%-- 
    Document   : uviewclouds
    Created on : Aug 31, 2016, 6:19:20 PM
    Author     : shaiksardar
--%>
                ...
                <div id="header">
                    ...
                    <div id="menu">
                        <ul>
                            ...
                            <li><a href="uviewclouds.jsp" class="active">ViewClouds</a></li>
...
while(rs.next()){
%>
<tr><td><font size="4" color="blue"><%=rs.getString(1)%></font></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td><font size="4" color="blue"><%=rs.getString(2)%></font></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td><img src="file//<%=rs.getString(5)%>" width="150" height="150"></td></tr>
<%
}
%>
                                    </table>
