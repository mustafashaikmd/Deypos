<%-- 
    Document   : cloudservicehome
    Created on : Aug 31, 2016, 4:50:30 PM
    Author     : shaiksardar
--%>
        ...
        <div id="bg_img">
            <div id="site_div">
                <div id="header">
                    ...
                    <div id="menu">
                        <ul>
                            <li><a href="cloudservicehome.jsp" class="active">Home</a></li>
...
<!--                                <img src="images/contact.png" alt="" title="" style="float: left; padding-right: 10px;" />-->
                                <h4>Cloud Service</h4>
                                <marquee><h2><font color="red">WELCOME TO CLOUDSERVICE HOME</font></h2></marquee>
                            </div>
