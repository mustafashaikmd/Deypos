<%-- 
    Document   : mviewcloud
    Created on : Aug 31, 2016, 6:32:42 PM
    Author     : shaiksardar
--%>
                ...
                <div id="header">
                    ...
                    <div id="menu">
                        <ul>
                            ...
                            <li><a href="mviewcloud.jsp" class="active">ViewCloud </a></li>
...
<!--                                <img src="images/contact.png" alt="" title="" style="float: left; padding-right: 10px;" />-->
                                <h4>View All Clouds</h4>
                                <center>
                                    <table border="">
                                        <tr><th><font size="4" color="red">ID</font></th><th><font size="4" color="red">NAME</font></th><th><font size="4" color="red">Profile</font></th></tr>
                                        <%@include file="jdbc.jsp" %>
                                        <%
                                                String sql="select * from ADDCLOUD order by FID";
                                                Statement s=con.createStatement();                                       
                                                ResultSet rs=s.executeQuery(sql);
                                                while(rs.next()){
                                        %>
                                        <tr><td><font size="4" color="blue"><%=rs.getString(1)%></font></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td><font size="4" color="blue"><a href="decry.jsp?val=<%=rs.getString(2)%>"><%=rs.getString(2)%></a></font></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td><img src="file//<%=rs.getString(5)%>" width="150" height="150"></td></tr>
                                        <%
                                        }
                                        %>
                                    </table>           
