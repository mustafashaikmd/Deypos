<%-- 
    ...
    Created on : Aug 31, 2016, 6:20:08 PM
    Author     : shaiksardar
--%>
...
<!--                                <img src="images/contact.png" alt="" title="" style="float: left; padding-right: 10px;" />-->
                                ...
                                <div class="pad_left">
                                    ...
                                    <p></p>
                                    <div id="contact_form">
                                        <form id="form2" method="post" action="searchfilesDB.jsp">
                                            <fieldset>
                                               
                                                <label for="con_mess">Search Any File:</label><br />
                                                <textarea id="con_mess" name="f2" cols="0" rows="0" placeholder="Enter Your File Name"></textarea><br />
